...
import {
  ...
  import ServiceBalanca from '../services/service_balanca';
...
const Balanca = () => {
    ...
    function sendConfigBalanca(){
        balancaService.sendConfigBalanca(
            selectedModel,
            selectedProtocol,
        );
    }
                ...
                <View style={styles.pickersView}>
                    ...
                    <View style={styles.buttonsView}>
                        <View style={styles.lineButtonView}>
                            <TouchableOpacity style={styles.actionButton} onPress={sendConfigBalanca}>
