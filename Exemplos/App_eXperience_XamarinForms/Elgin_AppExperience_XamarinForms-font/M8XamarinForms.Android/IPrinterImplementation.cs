...
namespace M8XamarinForms.Droid
{
    class IPrinterImplementation : IPrinter
    {
        ...
        public int ImprimeXMLNFCe(Dictionary<string,object> parametros)
        {
            return MainActivity.printer.ImprimeXMLNFCe(parametros);
        }

        public int ImprimeXMLSAT(Dictionary<string, object> parametros)
        {
        ...
        {
            return MainActivity.printer.CarregarArquivo(nomeArquivo);
        }
