...
import com.elgin.elginexperience.Services.E1BridgeService;
...
public class E1BridgePage extends AppCompatActivity {
    ...
    public final String PAGAMENTO_CREDITO = "Crédito";
    public final String PAGAMENTO_DEBITO = "Débito";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.selectedPaymentMethod = PAGAMENTO_CREDITO;
        this.selectedInstallmentType = FINANCIAMENTO_A_VISTA;

        buttonCreditOptionBridge.setBackgroundTintList(( AppCompatResources.getColorStateList(this, R.color.verde)));
        buttonAvistaOption.setBackgroundTintList(( AppCompatResources.getColorStateList(this, R.color.verde)));

        checkboxSendPassword.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        buttonCreditOptionBridge.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                //Mudando tipo de pagamento escolhido/redecorando botões/ reabilitando layout de parcelamento e número de parcelas
                buttonCreditOptionBridge.setBackgroundTintList(( AppCompatResources.getColorStateList(mContext, R.color.verde)));
                buttonDebitOptionBridge.setBackgroundTintList( AppCompatResources.getColorStateList(mContext, R.color.black));
        ...
        buttonDebitOptionBridge.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                //Mudando tipo de pagamento escolhido/redecorando botões/ desabilitando layout de parcelamento e número de parcelas
                buttonDebitOptionBridge.setBackgroundTintList(( AppCompatResources.getColorStateList(mContext, R.color.verde)));
                buttonCreditOptionBridge.setBackgroundTintList( AppCompatResources.getColorStateList(mContext, R.color.black));
        ...
        buttonStoreOptionBridge.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view){
                //Muda a decoração dos botões e atribuindo tipo de parcelamento

                buttonStoreOptionBridge.setBackgroundTintList(( AppCompatResources.getColorStateList(mContext, R.color.verde)));
                buttonAdmOptionBridge.setBackgroundTintList( AppCompatResources.getColorStateList(mContext, R.color.black));
                buttonAvistaOption.setBackgroundTintList( AppCompatResources.getColorStateList(mContext, R.color.black));
        ...
        buttonAdmOptionBridge.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                //Muda a decoração dos botões e atribuindo tipo de parcelamento

                buttonStoreOptionBridge.setBackgroundTintList(( AppCompatResources.getColorStateList(mContext, R.color.black)));
                buttonAdmOptionBridge.setBackgroundTintList( AppCompatResources.getColorStateList(mContext, R.color.verde));
                buttonAvistaOption.setBackgroundTintList( AppCompatResources.getColorStateList(mContext, R.color.black));
        ...
        buttonAvistaOption.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                buttonStoreOptionBridge.setBackgroundTintList(( AppCompatResources.getColorStateList(mContext, R.color.black)));
                buttonAdmOptionBridge.setBackgroundTintList( AppCompatResources.getColorStateList(mContext, R.color.black));
                buttonAvistaOption.setBackgroundTintList( AppCompatResources.getColorStateList(mContext, R.color.verde));
        ...
        buttonSendTransactionBridge.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                /**
                ...
                if(tryToUpdateBridgeServer() && isValueValidToElginPay() && isInstallmentsFieldValid()){
                    ...
                    String totalValue = editTextValueBridge.getText().toString().replaceAll(",", "");
        ...
        buttonCancelTransactionBridge.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
        ...
        buttonAdministrativeOperation.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ...
                builder.setItems(operations, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if(tryToUpdateBridgeServer()){
                            ...
                            String resultadoOperacao = bridgeService.IniciaOperacaoAdministrativa(generateRandomForBridgeTransactions(), PDV, which);
                            alertMessageStatus("Retorno E1 - BRIDGE", resultadoOperacao);
                        }
                    }
                });
        ...
        buttonPrintTestCoupon.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ...
                builder.setItems(couponTypes, new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int selected) {
                        ...
                        if(tryToUpdateBridgeServer()) {
                            ...
                            if (selected == NFCE_COUPON) {
                                ...
                                final String ASS_QR_CODE_EXEMPLO = "";
        ...
        buttonConsultTerminalStatus.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if(tryToUpdateBridgeServer()) {
                    //Habilita/Desabilita o envio de senha para validação no terminal
        ...
        buttonConsultConfiguredTimeout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if(tryToUpdateBridgeServer()) {
                    //Habilita/Desabilita o envio de senha para validação no terminal
        ...
        buttonConsultLastTransaction.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
               if(tryToUpdateBridgeServer()) {
                   //Habilita/Desabilita o envio de senha para validação no terminal
        ...
        buttonSetTransactionTimeout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                final AlertDialog.Builder builder = new AlertDialog.Builder(mContext);
                            ...
                            public void onClick(DialogInterface dialog, int whichButton) {
                                ...
                                if(newTimeoutInSeconds.equals("")){
                                   ...
                                   if(tryToUpdateBridgeServer()) {
                                       ...
                                       String resultadoOperacao = bridgeService.SetTimeout(Integer.parseInt(newTimeoutInSeconds));
                                       alertMessageStatus("Retorno E1 - BRIDGE", resultadoOperacao);
                                   }
                                }
                            }
        ...
        buttonSetTerminalPassword.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ...
                builder.setItems(enableOrDisable, new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        final AlertDialog.Builder enableOptionSelectedBuilder = new AlertDialog.Builder(mContext);
                        ...
                        // Criando um EditText para pegar o input do usuário na caixa de diálogo
                        final EditText innerInput = new EditText(mContext);
                        ...
                        enableOptionSelectedBuilder.setNegativeButton("CANCELAR", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                dialog.dismiss();
                            }
     ...
     */
    public boolean tryToUpdateBridgeServer(){
        ...
        if(isIpValid() && isTransactionPortValid() && isStatusPortValid()){
            bridgeService.SetServer(editTextIpBridge.getText().toString(), Integer.parseInt(editTextTransactionPort.getText().toString()), Integer.parseInt(editTextStatusPort.getText().toString()));
            return true;
        }
        return false;
    }
    ...
    public void shouldSendPassword(){
        final boolean HABILITAR_ENVIO_SENHA = true;
        final boolean DESABILITAR_ENVIO_SENHA  = false;
    ...
    private boolean isValueValidToElginPay(){
        ...
        String valueFormatted = editTextValueBridge.getText().toString().replaceAll(",", "\\.").trim();
    ...
    private boolean isInstallmentsFieldValid(){
        try{
            int intNumberOfInstallments = Integer.parseInt( String.valueOf(editTextNumberOfInstallmentsBridge.getText()));
