...
namespace M8
{
   [Activity(Label="Impressora")]
    public class Impressora : FragmentActivity
    {
        ...
        {
            string[] operations = { EXTERNAL_PRINTER_MODEL_I9, EXTERNAL_PRINTER_MODEL_I8, EXTERNAL_PRINTER_MODEL_I7_plus };
            ...
            builder.SetItems(operations, (c, ev) => {
                ...
                if (externalConnectionMethod.Equals("USB")) SetSelectedPrinterModelUSB(ev.Which);
                else SetSelectedPrinterModel(ev.Which);
        ...
        public void SetSelectedPrinterModelUSB(int whichSelected)
        {

            if (whichSelected == 0) selectedPrinterModel = EXTERNAL_PRINTER_MODEL_I9;
            if (whichSelected == 1) selectedPrinterModel = EXTERNAL_PRINTER_MODEL_I8;
            else selectedPrinterModel = EXTERNAL_PRINTER_MODEL_I7_plus;
        }
