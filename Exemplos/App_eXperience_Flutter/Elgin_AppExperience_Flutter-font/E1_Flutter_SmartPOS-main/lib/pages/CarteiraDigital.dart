...
class _SitefPageState extends State<DigitalWalletPage> {
  ...
  Widget qrCodeBase64Shipay() {
    ...
    return new Column(children: [
      Image.memory(bytes, fit: BoxFit.contain, width: 150, height: 150),
      SizedBox(height: 10),
      if (statusSaleShipay != '') ...{
        Row(
                    ...
                    children: [
                      ...
                      if (walletReturn == "pix") ...{
                        ...
                        GeneralWidgets.personButton(
                          ...
                          callback: () => getClipboardPix(),
                        ),
                      },
                      if (walletReturn == "mercadopago") ...{
                        SizedBox(height: 10),
                        GeneralWidgets.personButton(
                          width: 140,
                          textButton: "ABRIR MERCADO PAGO",
                          callback: () => getOpenMercadoPago(),
                        ),
                      }
                    ],
                  ),
