...
class PrinterService {
  ...
  Future<int> sendPrinterImage({required String pathImage}) async {
    Map<String, dynamic> mapParam = new Map();
  ...
  Future<int> connectExternalImpByIP(
      {required String model, required String ip, required int port}) async {
    Map<String, dynamic> mapParam = new Map();
  ...
  Future<int> connectExternalImpByUSB({required String model}) async {
    Map<String, dynamic> mapParam = new Map();
  ...
  Future<int> printerStop() async {
    Map<String, dynamic> mapParam = new Map();

    mapParam['typePrinter'] = "printerStop";
    return await _sendFunctionToAndroid(mapParam);
  }
}
