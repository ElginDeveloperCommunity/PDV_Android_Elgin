        ...
        <View style={styles.mainView}>
            ...
            <View style={styles.mainBarCodesView}>
                <View style={styles.barCodesView}>
                    ...
                    <View style={styles.barCodeTypeView}>
                        <View style={styles.codeView}>
                            ...
                            <Image style={styles.qrCodeImage} source={require('../icons/elginQRCode.png')}/>
                        </View>
                        <View style={styles.codeView}>
                            <Text style={styles.labelText}>EAN 13</Text>
                            <Image style={styles.eanCodeImage} resizeMode='contain' source={require('../icons/eanBarCode.png')}/>
                        </View>
                ...
                <View style={styles.buttonsView}>
                    <TouchableOpacity style={styles.submitionButton} onPress={() => inputOne.current.focus()} >
