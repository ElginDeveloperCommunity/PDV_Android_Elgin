         ...
         <View style={styles.menuView}>
           <View style={styles.buttonView}>
             <View style={styles.firstLine}> 
                  <TouchableOpacity style={styles.doubleButton} onPress={() => navigator.navigate('Bridge') }>
                    <Image style={styles.lgIcon} source={require('../icons/elginpay.png')}/>
                    <Text style={styles.textButton}>E1 - BRIDGE</Text>
                  </TouchableOpacity>
                  <TouchableOpacity style={styles.doubleButton} onPress={() => navigator.navigate('Nfce') }>
