...
const SAT = () => {
    ...
    function sendAtivarSat() {
        ...
        let actualEvent = DeviceEventEmitter.addListener('eventAtivarSat', event => {
    ...
    function sendAssociarSat(){
        ...
        let actualEvent = DeviceEventEmitter.addListener('eventAssociateSignature',event=> {
    ...
    function sendConsultarSat(){
        ...
        const mapParam={
            "typeSat":"consultSat",
            "numSessao": parseInt(numSessao),
        }

        satService.sendFunctionToAndroid(mapParam)

        let actualEvent = DeviceEventEmitter.addListener('eventConsultSat',event=> {
    ...
    function sendStatusOperacional(){
        ...
        satService.sendStatusSat(
            parseInt(numSessao),
            activationCode,
        )
        let actualEvent = DeviceEventEmitter.addListener('eventStatusOperacional',event=> {
    ...
    function cancelarVendaSat(){
        ...
        let actualEvent = DeviceEventEmitter.addListener('eventCancelSell',event=> {
