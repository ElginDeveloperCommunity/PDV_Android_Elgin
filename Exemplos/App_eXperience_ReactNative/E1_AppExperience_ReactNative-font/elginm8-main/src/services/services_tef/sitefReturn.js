export default class SitefReturn{
    ...
    vIAESTABELECIMENTO (){ return this.viaESTABELECIMENTO ? this.viaESTABELECIMENTO : "" }    

    setCodTrans (cODTRANS){ this.cODTRANS = cODTRANS }

    getcODAUTORIZACAO (){ return this.cODAUTORIZACAO ? this.cODAUTORIZACAO : "" }
    cOMPDADOSCONF (){ return this.cOMPDADOSCONF ? this.cOMPDADOSCONF : "" }
    bANDEIRA (){ return this.bANDEIRA ? this.bANDEIRA : "" }
    nUMPARC (){
        if (this.numPARC != null) return this.numPARC;
        return "";
    }
    cODTRANS (){ return  this.cODTRANS ? this.cODTRANS : "" }
    rEDEAUT (){ return this.rEDEAUT ? this.rEDEAUT: "" }
    nSUSITEF(){ return this.nSUSITEF }
    vIACLIENTE () { return this.viaCLIENTE ? this.viaCLIENTE: "" }
    vLTROCO (){ return this.vLTROCO }
    tipoPARC(){ return this.tipoPARC }
    getcODRESP (){return this.cODRESP ? this.cODRESP: "" }
    nSUHOST (){ return this.nSUHOST }

    getNameTransCod (){
        var retorno = "Valor invalido";

        switch (parseInt(this.tipoPARC)) {
            case 0:
                retorno = "A vista";
                break;
            case 1:
