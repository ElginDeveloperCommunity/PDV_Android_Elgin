...
class E1BridgePage : AppCompatActivity() {
    ...
    private lateinit var bridgeService: E1BridgeService

    //EditTexts
    private lateinit var editTextIpBridge: EditText
    private lateinit var editTextValueBridge: EditText
    private lateinit var editTextNumberOfInstallmentsBridge: EditText
    private lateinit var editTextTransactionPort: EditText
    private lateinit var editTextStatusPort: EditText
    private lateinit var editTextPassword: EditText

    //LinearLayout que agem como botão
    private lateinit var buttonCreditOptionBridge: LinearLayout
    private lateinit var buttonDebitOptionBridge: LinearLayout
    private lateinit var buttonStoreOptionBridge: LinearLayout
    private lateinit var buttonAdmOptionBridge: LinearLayout
    private lateinit var buttonAvistaOption: LinearLayout

    //Buttons
    private lateinit var buttonSendTransactionBridge: Button
    private lateinit var buttonCancelTransactionBridge: Button
    private lateinit var buttonAdministrativeOperation: Button
    private lateinit var buttonPrintTestCoupon: Button
    private lateinit var buttonConsultTerminalStatus: Button
    private lateinit var buttonConsultConfiguredTimeout: Button
    private lateinit var buttonConsultLastTransaction: Button
    private lateinit var buttonSetTerminalPassword: Button
    private lateinit var buttonSetTransactionTimeout: Button

    //Layout que devem ficar invisiveis para determinadas operações
    private lateinit var linearLayoutNumberOfInstallments: LinearLayout
    private lateinit var linearLayoutTypeInstallments: LinearLayout

    //Checkbox enviar senha
    private lateinit var checkboxSendPassword: CheckBox
    ...
    private val PAGAMENTO_CREDITO = "Crédito"
    private val PAGAMENTO_DEBITO = "Débito"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
       ...
       // editTextValueBridge.addTextChangedListener(InputMaskMoney(editTextValueBridge))
        ...
        buttonCreditOptionBridge.backgroundTintList = AppCompatResources.getColorStateList(
            this,
            R.color.verde
        )
        ...
        checkboxSendPassword.setOnClickListener {
            sendPassword = if (checkboxSendPassword.isChecked) {
        ...
        buttonCreditOptionBridge.setOnClickListener { //Mudando tipo de pagamento escolhido/redecorando botões/ reabilitando layout de parcelamento e número de parcelas
            buttonCreditOptionBridge.backgroundTintList = (AppCompatResources.getColorStateList(
                mContext,
                R.color.verde
            ))
            buttonDebitOptionBridge.backgroundTintList = AppCompatResources.getColorStateList(
                mContext,
                R.color.black
            )
        ...
        buttonDebitOptionBridge.setOnClickListener { //Mudando tipo de pagamento escolhido/redecorando botões/ desabilitando layout de parcelamento e número de parcelas
            buttonDebitOptionBridge.backgroundTintList = (AppCompatResources.getColorStateList(
                mContext,
                R.color.verde
            ))
        ...
        buttonStoreOptionBridge.setOnClickListener { //Muda a decoração dos botões e atribuindo tipo de parcelamento
            buttonStoreOptionBridge.backgroundTintList = (AppCompatResources.getColorStateList(
                mContext,
                R.color.verde
            ))
            buttonAdmOptionBridge.backgroundTintList = AppCompatResources.getColorStateList(
                mContext,
                R.color.black
            )
            buttonAvistaOption.backgroundTintList = AppCompatResources.getColorStateList(
        ...
        buttonAdmOptionBridge.setOnClickListener { //Muda a decoração dos botões e atribuindo tipo de parcelamento
            buttonStoreOptionBridge.backgroundTintList = (AppCompatResources.getColorStateList(
                mContext,
                R.color.black
            ))
        ...
        buttonAvistaOption.setOnClickListener { //Muda a decoração dos botões e atribuindo tipo de parcelamento
            buttonStoreOptionBridge.backgroundTintList = (AppCompatResources.getColorStateList(
                mContext,
                R.color.black
            ))
        ...
        buttonSendTransactionBridge.setOnClickListener {
            /**
            ...
            if (tryToUpdateBridgeServer() && isValueValidToElginPay && isInstallmentsFieldValid) {
                ...
                val totalValue = editTextValueBridge.text.toString().replace(",".toRegex(), "")
        ...
        buttonAdministrativeOperation.setOnClickListener {
        ...
        buttonPrintTestCoupon.setOnClickListener {
        ...
        buttonConsultTerminalStatus.setOnClickListener {
            if (tryToUpdateBridgeServer()) {
                //Habilita/Desabilita o envio de senha para validação no terminal
                shouldSendPassword()
        ...
        buttonConsultConfiguredTimeout.setOnClickListener {
            if (tryToUpdateBridgeServer()) {
                //Habilita/Desabilita o envio de senha para validação no terminal
                shouldSendPassword()
        ...
        buttonConsultLastTransaction.setOnClickListener {
            if (tryToUpdateBridgeServer()) {
                //Habilita/Desabilita o envio de senha para validação no terminal
                shouldSendPassword()
        ...
        buttonSetTerminalPassword.setOnClickListener {
            val enableOrDisable =
    ...
    private fun tryToUpdateBridgeServer(): Boolean {
     ...
     */
    private fun shouldSendPassword() {
    ...
    private fun alertMessageStatus(alertName: String?, messageAlert: String?) {
